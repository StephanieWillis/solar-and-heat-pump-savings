...
def render_solar_next_steps(solar_install: Solar):
    ...
    with st.expander("Find an installer"):
        st.write(
            """ The below list is installers we are aware of who have a good reputation. Get in touch if you would
...
def render_heat_pump_next_steps():
    ...
    with st.expander("Learn more about heat pumps"):
        ...
        st.write(
            "If you prefer videos, the [Heat Geek Youtube channel](https://www.youtube.com/watch?v=MU5KwrWumY8)"
            " has some great explainers."
        )

    with st.expander("Find an installer"):
        st.write(
            "A good installer will ensure your heat pump runs as efficiently as possible. The [heat geek map"
